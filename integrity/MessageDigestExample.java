...
public class MessageDigestExample {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
         ...
         */
//        final MessageDigest hashFunc = MessageDigest.getInstance("SHA-256");
        // use update function to concatenate
//        hashFunc.update(message.getBytes());
//        hashFunc.update(message2.getBytes());
//        final byte hashed = hashFunc.digest();
